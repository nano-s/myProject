...
st.title("🖐️ วิเคราะห์สารเรืองแสงจากรูปมือที่กำหนด")
...
if uploaded_file:
    ...
    # สร้าง mask จากภาพมือเส้นที่คุณอัปโหลดไว้ (สมมุติว่าเป็นภาพขาวดำ: มือ = ขาว, พื้นหลัง = ดำ)
    hand_outline = cv2.imread("hand_outline.jpg", cv2.IMREAD_GRAYSCALE)  # ← เปลี่ยนเป็นชื่อภาพมือเส้นของคุณ
