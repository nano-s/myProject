...
if uploaded_file:
    ...
    # ตรวจสอบว่ามีไฟล์ hand_outline.jpg อยู่ไหม
    if not os.path.exists("hand_outline.jpg"):
        st.error("❌ ไม่พบไฟล์ hand_outline.jpg ในโฟลเดอร์! กรุณาวางภาพไว้ในโฟลเดอร์เดียวกับ app.py")
    else:
        # โหลดภาพเส้นมือ
